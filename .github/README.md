...
[`@aws-sdk/client-cognito-sync`](https://www.npmjs.com/package/@aws-sdk/client-cognito-sync/v/3.92.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.92.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uHZMzjCVSpLRLuzy0yncEqB0Urf7XyurS45zS4rcAKIphl1tpHvxogHEBdZK3tDK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cognito-sync": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.92.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.92.0/index.min.mjs": "sha384-uHZMzjCVSpLRLuzy0yncEqB0Urf7XyurS45zS4rcAKIphl1tpHvxogHEBdZK3tDK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cognito-sync/blob/refs/tags/3.92.0/LICENSE
```
