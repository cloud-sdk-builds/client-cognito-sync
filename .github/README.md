...
[`@aws-sdk/client-cognito-sync`](https://www.npmjs.com/package/@aws-sdk/client-cognito-sync/v/3.922.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.922.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cBe+bghoDli2SJfVtOi2NrRivSTUYaEqnMd94l6MpdaqsqzM1SrB/PuZbOSYv37o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cognito-sync": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.922.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.922.0/index.min.mjs": "sha384-cBe+bghoDli2SJfVtOi2NrRivSTUYaEqnMd94l6MpdaqsqzM1SrB/PuZbOSYv37o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cognito-sync/blob/refs/tags/3.922.0/LICENSE
```
