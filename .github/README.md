...
[`@aws-sdk/client-cognito-sync`](https://www.npmjs.com/package/@aws-sdk/client-cognito-sync/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7Uij8JOIfN6d9+xqMxSDUwBtvrNMTlCxSaA5PKMtyIoKGs+fALFCGzHDe6sQL7i0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cognito-sync": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.919.0/index.min.mjs": "sha384-7Uij8JOIfN6d9+xqMxSDUwBtvrNMTlCxSaA5PKMtyIoKGs+fALFCGzHDe6sQL7i0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cognito-sync/blob/refs/tags/3.919.0/LICENSE
```
