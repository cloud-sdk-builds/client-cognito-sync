...
[`@aws-sdk/client-cognito-sync`](https://www.npmjs.com/package/@aws-sdk/client-cognito-sync/v/3.460.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.460.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-p4qpGs2ulRYweYg1L1rAZFHGaycdTeJwi0POoou4wMePeFloZTtquNs1WstIOcU2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cognito-sync": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.460.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cognito-sync@3.460.0/index.min.mjs": "sha384-p4qpGs2ulRYweYg1L1rAZFHGaycdTeJwi0POoou4wMePeFloZTtquNs1WstIOcU2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cognito-sync/blob/refs/tags/3.460.0/LICENSE
```
